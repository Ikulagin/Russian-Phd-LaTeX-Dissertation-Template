...
%\documentclass[a4paper,14pt,oneside,openany]{scrreprt}
...
%\include{Dissertation/part2}           % Глава 2 PGAS
%\include{Dissertation/part3}           % Глава 3 SMP/NUMA synchronization
%\include{Dissertation/part4}           % Глава 4 Мультикластерная ВС
